...
//               >
//                 <SelectTrigger>
//                   <SelectValue placeholder={watchedDepartmentId ? "Select office" : "Select department first"} />
//                 </SelectTrigger>
//                 <SelectContent>
...
//               Adding your location helps us route your query to the nearest office
//             </p>
//           </div>
...
//   )
// }
// components/query-form.tsx (your file path)
"use client"
...
// --- REMOVE THE Panchayat INTERFACE ---
...
export function QueryForm() {
  ...
  useEffect(() => {
    // --- REMOVE THE Panchayat FETCH LOGIC ---
    ...
    <Card className="max-w-2xl mx-auto">
      ...
      <CardContent>
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          {/* --- REPLACE THE OLD SELECT BLOCK WITH THIS INPUT BLOCK --- */}
          <div className="space-y-2">
          ...
          {showLocationPicker && <LocationPicker onLocationSelect={handleLocationSelect} initialLocation={location || undefined} />}
